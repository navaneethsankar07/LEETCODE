<h2><a href="https://leetcode.com/problems/earliest-time-to-finish-one-task/?envType=problem-list-v2&envId=vivcrzmv">3683. Earliest Time to Finish One Task</a></h2><h3>Easy</h3><hr><p>You are given a 2D integer array <code>tasks</code> where <code>tasks[i] = [s<sub>i</sub>, t<sub>i</sub>]</code>.</p>
